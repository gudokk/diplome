    ...
    useEffect(() => {
        ...
        const gameLoop = setInterval(() => {
            setTrees((prev) => {
                ...
                const newTree = Math.random() < 0.03
                    ? {x: Math.random() * (canvasWidth - treeWidth), y: canvasHeight + treeHeight}
                    : null;
    ...
    return (
        <div className="flex flex-col min-h-screen">
            ...
            <main className="flex-grow flex items-center justify-center">
                <div
                    className="bg-white rounded-xl shadow-2xl max-w-4xl w-full mt-12 mx-auto p-8 transition-all duration-300 animate-fade-in">
