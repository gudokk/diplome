...
const ProfilePage = () => {
  ...
  return (
    <div className={styles["profile-page"]}>
      <Header />
      <div className="bg-white rounded-xl shadow-2xl max-w-4xl w-full mx-auto mt-12 w-full p-8 transition-all duration-300 animate-fade-in">
        <div className="flex flex-col md:flex-row">
          <div className="md:w-1/3 text-center mb-8 md:mb-0">
            ...
            />
            <h1 className="text-2xl font-bold text-blue-800  mb-2">John Doe</h1>
