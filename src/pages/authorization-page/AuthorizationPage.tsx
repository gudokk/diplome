...
import styles from "./ui/AuthorizationPage.module.css";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        console.log("Токен авторизации:", result.access_token);

        localStorage.setItem("token", result.access_token); // сохранить токен локально
